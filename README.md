...
local en el que se encuentra a la carpeta de la imagen /app/test, es por esta razón que no ha sido necesario incluir ningún fichero de test ni código fuente 
